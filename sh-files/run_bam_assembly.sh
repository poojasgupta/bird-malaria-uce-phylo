...
#SBATCH --job-name=abyss-bam-dilc-unen-assembly
#SBATCH --ntasks=1
#SBATCH --nodes=1
...
time phyluce_assembly_assemblo_abyss \
     --config /scratch/pg84794/UCE_run5/conf-files/cl-dilc-unen-bam-assembly.conf \
     --output /scratch/pg84794/UCE_run5/abyss-bam-dilc-unen-assembly-k55 \
     --kmer 55 \
     --cores 20 \
     --clean
